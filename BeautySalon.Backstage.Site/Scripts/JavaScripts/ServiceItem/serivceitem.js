...
const config = {
    setup() {
        ...
        const deleteService = () => {
            const confirmation = confirm(`確定刪除服務項目 ${service.value.ServiceName}?`);
            if (confirmation) {
                ...
                fetch(url, {
                    ...
                    .then(response => {
                        ...
                        window.location.href = '服務項目列表.html'; // 刪除後返回列表頁
                    })
                    .catch(error => {
        ...
        const saveService = () => {
            ...
            const requestBody = {
                ...
                CreatedDate: service.value.CreatedDate,
            ...
            fetch(url, {
                ...
                .then(response => {
                    ...
                    window.location.href = '服務項目列表.html'; // 儲存後返回列表頁
                })
                .catch(error => {
        ...
        const goBack = () => {
            window.location.href = '服務項目列表.html'; // 返回列表頁
        };
